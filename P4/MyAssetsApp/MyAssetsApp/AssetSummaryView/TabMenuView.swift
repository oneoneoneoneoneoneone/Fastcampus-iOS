...
struct TabMenuView: View {
    var tabs: [String]
    //@Binding - 바인딩 하는 변수 / constant() - 바인딩하는 값
...
struct TabMenuView_Previews: PreviewProvider {
    static var previews: some View {
        TabMenuView(tabs: ["지난달 결제", "이번달 결제", "다음달 결제"],
                    selectedTab: .constant(0), //value에 변결할 수 없는 값으로 바인딩 함
                    updated: .constant(.currentMonth(amount: "100,400원"))   //어케 돌아가는거고
        )
    }
}
